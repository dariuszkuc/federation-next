...
impl OpPath {
    ...
    pub(crate) fn conditional_directives(&self) -> DirectiveList {
        DirectiveList(self.0.iter()
            .map(|path_element| path_element.directives()
                .iter()
...
pub(crate) fn concat_paths_in_parents(first: &Option<Arc<OpPath>>, second: &Option<Arc<OpPath>>) -> Option<Arc<OpPath>> {
